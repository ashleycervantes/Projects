...
# This ensures that if a user is missing a package, it gets installed.
if (!require("pacman")) install.packages("pacman")
pacman::p_load(readr, tidyverse, shiny, leaflet, dplyr)

# 2. LOAD DATA FROM GITHUB
# Using the "Raw" URLs from your GitHub repository so anyone can run this.
mural_url <- "https://raw.githubusercontent.com/ashleycervantes/Projects/main/Chicago%20Mural%20Project/Mural_Registry_20241126.csv"
images_url <- "https://raw.githubusercontent.com/ashleycervantes/Projects/main/Chicago%20Mural%20Project/mural%20images.csv"

# Reading the data directly from the web
mural <- read_csv(mural_url, locale = locale(encoding = "UTF-8"))
mural_images <- read_csv(images_url, locale = locale(encoding = "UTF-8"))
